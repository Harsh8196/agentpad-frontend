...
const VariableNode: React.FC<VariableNodeProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white border-2 border-purple-300 rounded-lg p-4 shadow-md min-w-[180px]">
      ...
      {config && (
        <div className="bg-purple-50 p-2 rounded text-xs text-purple-800 mb-2">
